...
import com.intelligent.marking.common.manager.AutoGridLayoutManager;
...
public class PageRecyclerView extends RecyclerView {
    ...
    private void defaultInit(Context context) {
        ...
        this.mAutoGridLayoutManager = new AutoGridLayoutManager(mContext, spanRow, AutoGridLayoutManager.HORIZONTAL, false);
