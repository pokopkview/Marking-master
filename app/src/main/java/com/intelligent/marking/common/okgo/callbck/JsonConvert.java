 ...
 */
package com.intelligent.marking.common.okgo.callbck;
...
import com.intelligent.marking.common.okgo.exception.MyException;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != ResponseBean.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                response.close();
                int code = responseBean.status;//状态 1获取成功
                int msg = responseBean.count;//数据总量
                if (code == 1) { //约定 正确返回码
